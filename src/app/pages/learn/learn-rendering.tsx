...
export function LearnRenderingPage(): VirtualNode {
                ...
                <div class="container mx-auto px-4 flex">
                    ...
                    <main class="flex-1 max-w-3xl">
                        ...
                        <section class="mb-8">
                            ...
                            <p class="mb-4">
                                In Coreact, components are the building blocks
                                of your UI. They are reusable, self-contained
                                pieces of code that return what should appear on
                                the screen.
                            </p>
                        </section>
    ...
    return <h1>Hello, World!</h1>;
                        ...
                        <section class="mb-8">
                            ...
                            <p class="mb-4">
                                Coreact elements are the smallest building
                                blocks of Coreact applications. They describe
                        ...
                        <section class="mb-8">
                            ...
                            <p class="mb-4">
                                ...
                                conditional (ternary) operator to create
