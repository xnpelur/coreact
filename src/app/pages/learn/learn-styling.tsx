...
export function LearnStylingPage(): VirtualNode {
                ...
                <div class="container mx-auto px-4 flex">
                    ...
                    <main class="flex-1 max-w-3xl">
                        ...
                        <section class="mb-8">
                            ...
                            <p class="mb-4">
                                You can use the <code>class</code> prop to apply
                                CSS classes to your elements. Coreact supports
                                both regular CSS and CSS-in-JS solutions.
                            </p>
    ...
    return <button class="px-4 py-2 bg-blue-500 text-white rounded">Click me</button>;
                        ...
                        <section class="mb-8">
                            ...
                            <p class="mb-4">
                                For dynamic styles, you can pass a JavaScript
                                object to the <code>style</code> prop.
                            </p>
                            <pre class="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg overflow-x-auto text-sm mb-4">
                                <code>
                                    {`function ColoredBox() {
