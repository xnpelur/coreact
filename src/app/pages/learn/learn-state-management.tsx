                ...
                <div class="container mx-auto px-4 flex">
                    ...
                    <main class="flex-1 max-w-3xl">
                        ...
                        <section class="mb-8">
                            ...
                            <p class="mb-4">
                                State allows components to manage and track
                                changes to data over time. In Coreact, you can
                        ...
                        <section class="mb-8">
                            ...
                            <p class="mb-4">
                                The <code>useState</code> hook lets you add
        ...
        <div>
            ...
            <button onClick={() => setCount(count + 1)}>Increment</button>
                        ...
                        <section class="mb-8">
                            ...
                            <p class="mb-4">
                                For global state that needs to be accessed by
                                many components, you can use the Context API.
                            </p>
                        </section>
                        ...
                        <section class="mb-8">
                            ...
                            <p class="mb-4">
                                ...
                                external state management solutions like Redux
                                or Zustand.
                            </p>
                        </section>
