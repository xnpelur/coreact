                    ...
                    <main class="flex-1 max-w-3xl">
                        ...
                        <section class="mb-8">
                            ...
                            <p class="mb-4">
                                ...
                                components in your application, keeping the UI
                        ...
                        <section class="mb-8">
                            ...
                            <p class="mb-4">
                                ...
                                using the <code>Router</code> and{" "}
                                <code>Route</code> components.
                            </p>
        ...
        <nav>
            ...
            <Link href="/about">About</Link>
                        ...
                        <section class="mb-8">
                            ...
                            <p class="mb-4">
                                You can define dynamic segments in your routes
                                using the <code>:</code> syntax.
                            </p>
                            <pre class="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg overflow-x-auto text-sm mb-4">
                                <code>
                                    {`// In your router
