        ...
        <div class="min-h-screen flex flex-col text-lg bg-white dark:bg-darkgray text-gray-700 dark:text-gray-100 leading-base">
            ...
            <div class="flex flex-1 pt-4 justify-between">
                ...
                <main class="flex-2 max-w-4xl px-8 pt-2 mx-auto">
                    <Heading level={1} text={t("docsPage.heading.gettingStarted")} />
                    <section class="mb-8">
                        <Paragraph text={t("docsPage.paragraph.welcome")} />
                        <Paragraph text={t("docsPage.paragraph.frameworkDescription")} />
                    </section>

                    <section class="mb-12">
                        <Heading level={2} text={t("docsPage.heading.installation")} />
                        <Paragraph text={t("docsPage.paragraph.installation")} />
                        <Code
...
npm run dev"
                        />
                        <Paragraph text={t("docsPage.paragraph.developmentServer")} />
                    </section>

                    <section class="mb-12">
                        <Heading level={2} text={t("docsPage.heading.projectStructure")} />
                        <Paragraph text={t("docsPage.paragraph.projectStructure")} />
                        <Code
                            text="/src
  ...
  └── main.ts     ← Mounts your main App component"
                        />
                        <Paragraph text={t("docsPage.paragraph.separationOfLogic")} />
                    </section>

                    <section class="mb-12">
                        <Heading level={2} text={t("docsPage.heading.whatsNext")} />
                        <Paragraph text={t("docsPage.paragraph.exploreCoreModules")} />
                        <ul class="list-disc pl-6 mb-4">
                            <li class="mb-2">
                                ...
                                >
                                    <strong>{t("docsPage.link.rendering")}</strong>
                                </Link>{" "}
