    ...
    return (
        <div className="mx-5 mt-24 mb-32 flex flex-col justify-center">
            ...
            <div className="mt-5 self-center flex gap-2 w-auto flex-row">
                <a
                    className="w-auto justify-center scale-[.98] transition-transform inline-flex font-bold items-center outline-none focus:outline-none focus-visible:outline focus-visible:outline-cyan-600 focus:outline-offset-2 focus-visible:dark:focus:outline-blue-400 leading-snug bg-cyan-600 text-white dark:bg-cyan-600-dark dark:text-gray-700 text-lg py-3 rounded-full px-6"
                    target="_self"
                    href="/learn"
                >
                    Learn Coreact
