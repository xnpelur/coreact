                    ...
                    <div className="text-base items-center gap-1.5 flex flex-1 flex-row justify-end">
                        <div className="mx-2.5 gap-1.5 flex">
                            <div className="flex flex-1">
                                <a
                                    className="scale-95 transition-transform w-full text-center outline-cyan-600 py-1.5 px-4 rounded-full capitalize whitespace-nowrap hover:bg-gray-900/5 hover:dark:bg-text-gray-50/5"
                                    href="#"
                                >
                                    Learn
                                </a>
                        ...
                        <div className="flex items-center space-x-0">
                            ...
                            <div className="flex">
                                <a
                                    className="scale-95 transition-transform flex w-12 h-12 rounded-full items-center justify-center hover:bg-gray-900/5 hover:dark:bg-text-gray-50/5 outline-cyan-600"
                            ...
                            <div className="flex">
                                <a
                                    className="flex items-center justify-center w-12 h-12 transition-transform rounded-full scale-95 hover:bg-gray-900/5 hover:dark:bg-text-gray-50/5 outline-cyan-600"
                                    target="_blank"
