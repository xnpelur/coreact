    ...
    return (
        <div className="flex relative" data-lang-combobox>
            <button
                ...
                className="flex items-center justify-center w-12 h-12 rounded-full cursor-pointer transition-all duration-200 ease-out hover:bg-darkgray/10 hover:dark:bg-gray-50/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-600"
                data-lang-combobox
                onClick={toggleOpen}
            ...
            <ul
                ...
                class={"language-dropdown " + (open ? "open" : "closed")}
                data-lang-combobox
            >
                <li
                    key="en"
                    ...
                    className={
                        "px-4 py-2 cursor-pointer hover:bg-cyan-100 dark:hover:bg-cyan-900" +
                        (language === "en"
